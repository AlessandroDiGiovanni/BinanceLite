...
import { AuthServiceService, SignUpFormInterface, LoginFormInterface } from '../providers/auth-service.service';
...
export class LoginPage implements OnInit {
  ...
  constructor(private router: Router, private storage: Storage, public formBuilder: FormBuilder, public service:AuthServiceService, public toastController: ToastController) { 
